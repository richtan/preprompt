...
- Command history per agent: growing list of actions, deduped, capped at 15
- Comparison table: criteria groups as rows, agents as columns, failure notes
- Tree-style file summary from snapshot diff (no polling)
